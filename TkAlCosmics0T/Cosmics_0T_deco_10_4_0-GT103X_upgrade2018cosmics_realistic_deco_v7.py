...
# with command line options: UndergroundCosmicSPLooseMu_cfi.py --conditions 103X_upgrade2018cosmics_realistic_deco_v7 -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO,ALCA:TkAlCosmics0T -n 100 --era Run2_2018 --eventcontent ALCARECO --scenario cosmics --datatier ALCARECO --beamspot Realistic25ns13TeVEarly2018Collision --no_exec --magField 0T
...
# Output definition
outrootfile='file:step1_UndergroundCosmicSPLooseMu_deco_0T_'+str(process.GlobalTag.globaltag.value())+"_"+str(options.maxEvents)+'_evts_seed_'+str(options.myseed)+'.root'
